...
<div class="contacts-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-9" style="padding: 0 5px 0 0">
            ...
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    <?= Html::submitButton($model->isNewRecord ? \Yii::t('contacts', 'Create') : \Yii::t('contacts', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
                </div>
